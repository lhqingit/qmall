...
<div style="padding:10px 10px 10px 10px">
	<form id="itemeEditForm" class="itemForm" method="post">
	    ...
	    <table cellpadding="5">
	        ...
	        <tr>
	            <td>商品图片:</td>
	            <td id="qImageTdUseForResetImage">
	            	<a href="javascript:void(0)" class="easyui-linkbutton picFileUpload">上传图片</a>
	                <input type="hidden" name="image"/>
	            	<a href="javascript:void(0)" class="easyui-linkbutton" onclick="resetImageQ()">重置</a>
	            </td>
	        </tr>
	        <tr>
	            <td>商品描述:</td>
...
<script type="text/javascript">
	...
	//重置上传的商品图片
	function resetImageQ(){
		//Q:移除之前回显的商品图片
		$('#qImageTdUseForResetImage .pics ul').empty();
		//Q:将保存的，上传图片的访问url值清空
		$('#qImageTdUseForResetImage input[name="image"]').val('');
	}
</script>
