 ...
 * Generated at: 2018-02-14 08:49:34 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\tif(r){\r\n");
      out.write("\t\t\t\t$.post(\"/content/category/delete/\",{id:node.id},function(qmallResult){\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tif(qmallResult.status == 200){\r\n");
      out.write("\t\t\t\t\t\t//Q:如果后台返回删除成功则移除节点\r\n");
      out.write("\t\t\t\t\t\ttree.tree(\"remove\",node.target);\r\n");
      out.write("\t\t\t\t\t} else{\r\n");
      out.write("\t\t\t\t\t\t//Q:否则如果包含信息。则弹出信息\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tif(qmallResult.msg){\r\n");
      out.write("\t\t\t\t\t\t\talert(qmallResult.msg);\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\r\n");
